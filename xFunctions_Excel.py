...
def WriteToExcel(version,df_results_values,Start_date,End_date,result_folder): 
    ...
    columns = ['P_PEM', 'P_import', 'P_export', 'P_grid', 'z_grid', 'P_PV',
           ...
           'c_aFRR_up', 'r_aFRR_down', 'c_aFRR_down', 'Raw Storage', 'Pure Storage', 'CO2 flow', 'Raw inflow',
           'DA clearing', 'vOPEX']
    ...
    if version == 1: 
        ...
        Results['Raw Storage'] = df_results_values['s_raw'].tolist()
        Results['Pure Storage'] = df_results_values['s_pu'].tolist()
        Results['CO2 flow'] = df_results_values['m_CO2'].tolist()
        Results['Raw inflow'] = df_results_values['m_ri'].tolist()
    ...
    if version == 2: 
        ...
        Results['z_grid'] = df_results_values['z_grid'].tolist()
        Results['P_PV'] = df_results_values['P_PV'].tolist()
        Results['r_FCR'] = df_results_values['r_FCR'].tolist()
        Results['c_FCR'] = df_results_values['c_FCR'].tolist()
        Results['r_mFRR_up'] = df_results_values['r_mFRR_up'].tolist()
        Results['c_mFRR_up'] = df_results_values['c_mFRR_up'].tolist()
        Results['r_aFRR_up'] = df_results_values['r_aFRR_up'].tolist()
        Results['c_aFRR_up'] = df_results_values['c_aFRR_up'].tolist()
        Results['r_aFRR_down'] = df_results_values['r_aFRR_down'].tolist()
        Results['c_aFRR_down'] = df_results_values['c_aFRR_down'].tolist()
        Results['Raw Storage'] = df_results_values['s_raw'].tolist()
        Results['Pure Storage'] = df_results_values['s_pu'].tolist()
        Results['CO2 flow'] = df_results_values['m_CO2'].tolist()
        Results['Raw inflow'] = df_results_values['m_ri'].tolist()
